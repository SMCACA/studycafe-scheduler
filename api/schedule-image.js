// ================================================================
// 📁 api/schedule-image.js   ← 반드시 .js 확장자! (jsx 아님)
// ================================================================
// 시간표를 PNG 이미지로 만들어주는 Vercel API 함수예요.
// ================================================================
...
// ── JSX 없이 화면 구성하는 헬퍼 함수 ──
// 마치 레고 블록처럼: h('div', {스타일}, 내용1, 내용2, ...)
    ...
    h('div', {
      ...
      h('div', { style: { display: 'flex', flexDirection: 'column', gap: 7 } },
        ...
        h('div', { style: { display: 'flex', gap: 10, fontSize: 14, color: '#64748B' } },
          grade && h('span', null, grade),
          seat  && h('span', null, `좌석 ${seat}번`),
